...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("UpLink Suporte".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["131.255.153.12"];
pub const RS_PUB_KEY: &str = "hpg18IhxALyhb1oB5fAmqARiFlQbSmAXudN1DlzlC4M=";
